<div class="box">
    ...
    <div class="box-body">
        ...
        <div class="input-group col-md-12">
            ...
            <input id="searchproduct-{$plate_id}" type="text" value="" placeholder="Pesquise um item..." onkeyup="searchClient(event, '{$smarty.const.BASEDIR}request/searchproduct?search=' + this.value + '&request_id={$request_id}&plate_id={$plate_id}&action=selproductnew')"/>
